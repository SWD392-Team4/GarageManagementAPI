...
namespace GarageManagementAPI.Repository.Contracts
{
    ...
    {
        Task<PagedList<ServiceImage>> GetServiceImgByIdServiceAsync(Guid serviceImageId, ServiceImageParameters serviceImageParameters, bool trackChanges, string? include = default);
