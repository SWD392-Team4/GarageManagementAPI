...
namespace GarageManagementAPI.Service.Contracts
{
    ...
    {
        public Task<Result<ExpandoObject>> GetBrandAsync(Guid brandId, BrandParameters brandParameters, bool trackChanges, string? include = null);
        public Task<Result<IEnumerable<ExpandoObject>>> GetBrandsAsync(BrandParameters brandParameters, bool trackChanges, string? include = null);
