...
namespace GarageManagementAPI.Service.Contracts
{
    ...
    {
        Task<Result<IEnumerable<AppointmentReplacementPartDto>>> GetAppointmentReplacementPartsAsync(Guid garageId, Guid appointmentId, Guid appointmentDetailId, AppoitnmentReplacementPartParameters appoitnmentReplacementPartParameters);
