...
namespace GarageManagementAPI.Service.Contracts
{
    public interface IProductService
    {
        ...
        public Task<Result<IEnumerable<ExpandoObject>>> GetProductsAsync(Guid warehouseId,ProductParameters productParameters, bool trackChanges, string? include = null);
